from Playwright.automationProject.resources.pages.home_page import HomePage
from Playwright.automationProject.resources.pages.signup_login_page import SignupLoginPage
from Playwright.automationProject.resources.pages.account_creation_page import AccountCreationPage
from Playwright.automationProject.resources.pages.product_page import ProductPage
from Playwright.automationProject.resources.pages.cart_page import CartPage
from Playwright.automationProject.resources.pages.checkout_page import CheckoutPage
from Playwright.automationProject.resources.pages.payment_page import PaymentPage
from Playwright.automationProject.data.details import user_details
from Playwright.automationProject.resources.locators.locators import locator
